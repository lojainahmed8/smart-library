        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 border border-gray-100">
                ...
                <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Password (Leave blank to keep existing)</label>
                    ...
                    <div class="flex justify-end space-x-2">
                        ...
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg shadow-sm">Update User</button>
                    </div>
                </form>
